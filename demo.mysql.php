...
include("./pog/configuration.php");
define('GETID3_DB_HOST',  $configuration["host"]);
define('GETID3_DB_USER',  $configuration["user"]);
define('GETID3_DB_PASS',  $configuration["pass"]);
define('GETID3_DB_DB',    $configuration["db"]);
